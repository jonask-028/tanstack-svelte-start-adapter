...
createStartHandler, 
// Request utilities
getRequest, getRequestHeaders, getRequestHeader, getRequestIP, getRequestHost, getRequestProtocol, getRequestUrl, 
// Response utilities
getResponse, getResponseHeaders, getResponseHeader, setResponseHeader, setResponseHeaders, removeResponseHeader, clearResponseHeaders, getResponseStatus, setResponseStatus, 
// Cookie utilities
getCookies, getCookie, setCookie, deleteCookie, 
// Session utilities
useSession, getSession, updateSession, sealSession, unsealSession, clearSession, 
// Query validation
getValidatedQuery, 
// Handler utilities
defineHandlerCallback, 
// Constants
HEADERS, } from "@tanstack/start-server-core";
 ...
 * ```
 */
export const defaultRenderHandler = defineHandlerCallback(({ request, router, responseHeaders }) => {
    const { html, head } = renderStartServer(router);
    const fullHtml = wrapHtmlDocument(html, head, router);
    const headers = new Headers(responseHeaders);
    headers.set("Content-Type", "text/html; charset=utf-8");
