 ...
 * ```
 */
export declare function createNodeHandler(handler: RequestHandler<Register>): (req: {
    url?: string;
    method?: string;
 ...
 * ```
 */
export declare function createBunHandler(handler: RequestHandler<Register>): RequestHandler<Register>;
/**
 ...
 * ```
 */
export declare function createDenoHandler(handler: RequestHandler<Register>): RequestHandler<Register>;
